...
@Client.on_message(filters.private & filters.photo & filters.private)                
...
@Client.on_message(filters.private & filters.command("view") & filters.private)                     
...
@Client.on_message(filters.private & filters.command(["del", "del_thumb"]) & filters.private)                        
